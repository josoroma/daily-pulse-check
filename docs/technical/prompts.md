...
- [Prompt 1–3 — `setup`: E1 Project Setup](#prompt-1--setup)
- [Prompt 4 — `infra`: Supabase env fix](#prompt-4--infra)
- [Prompt 5–6 — `auth`: E2 Auth planning & implementation](#prompt-5--auth)
- [Prompt 7–9 — `infra`: Middleware, OAuth, signup fixes](#prompt-7--infra)
- [Prompt 10–11 — `auth`/`infra`: Redirect URL fixes](#prompt-10--auth)
- [Prompt 12–17 — `frontend`: UI fixes, dark theme](#prompt-12--frontend)
- [Prompt 18–24 — `market`: E3 Market Data Engine](#prompt-18--market)
- [Prompt 25–31 — `portfolio`/`setup`: E4 Portfolio, date-fns](#prompt-25--portfolio)
- [Prompt 32–37 — `dca`: E5 DCA Automation](#prompt-32--dca)
- [Prompt 38–48 — `insights`: E6 AI-Powered Insights](#prompt-38--insights)
- [Prompt 49–54 — `alerts`: E7 Alerts & Notifications](#prompt-49--alerts)
- [Prompt 55–63 — `bitcoin`: E8 On-Chain Analytics](#prompt-55--bitcoin)
- [Prompt 64–72 — `settings`: E10 Settings & Data Management](#prompt-64--settings)
- [Prompt 73–76 — `dashboard`/`frontend`: E11 Dashboard, E12 Luma Theme](#prompt-73--dashboardfrontend)
